...
namespace AVRO
{
    public class AVRO_Functions_Lite
    {
        ...
        public static void SetAndroidPlatform(AVRO_Ticket _ticket)
        {
        ...
        public static void SetColorSpaceLinear(AVRO_Ticket _ticket)
        {
        ...
        public static void SetMSAAFallbackDowngrade(AVRO_Ticket _ticket)
        {
            string _path = "ProjectSettings/ProjectSettings.asset";
            if (!File.Exists(_path)) return;
            string _content = File.ReadAllText(_path);
            string _newContent = Regex.Replace(_content, @"(unsupportedMSAAFallback:\s*)1", "${1}0");
        ...
        public static void SetGraphicsJobsEnabled(AVRO_Ticket _ticket)
        {
        ...
        public static void SetPrebakeCollisionMeshes(AVRO_Ticket _ticket)
        {
        ...
        public static void SetOptimizeMeshData(AVRO_Ticket _ticket)
        {
        ...
        public static void SetMipmapStripping(AVRO_Ticket _ticket)
        {
        ...
        {
            return PlayerSettings.GetManagedStrippingLevel(NamedBuildTarget.Android) == ManagedStrippingLevel.Medium ||
            PlayerSettings.GetManagedStrippingLevel(NamedBuildTarget.Android) == ManagedStrippingLevel.High ?
            AVRO_Settings.TicketStates.Done : AVRO_Settings.TicketStates.Todo;
        }
        public static void SetStrippingLevel(AVRO_Ticket _ticket)
        {
        ...
        public static void SetDisableAutoGraphicsAPI(AVRO_Ticket _ticket)
        {
        ...
        public static void SetMultiThreadedRendering(AVRO_Ticket _ticket)
        {
        ...
        public static void SetTextureCompressionASTC(AVRO_Ticket _ticket)
        {
        ...
        public static void SetVulkanGraphicsAPI(AVRO_Ticket _ticket)
        {
        ...
        {
            // This is not well documented, so we do a simpler approach:
            return PlayerSettings.GetStaticBatchingForPlatform(BuildTarget.Android) ? AVRO_Settings.TicketStates.Done : AVRO_Settings.TicketStates.Todo;
        }
        public static void SetStaticBatching(AVRO_Ticket _ticket)
        {
        ...
        public static void SetMinAPILevel32(AVRO_Ticket _ticket)
        {
        ...
        public static void SetTargetAPILevel32(AVRO_Ticket _ticket)
        {
        ...
        public static void SetRealtimeReflectionProbesDisabled(AVRO_Ticket _ticket)
        {
        ...
        public static void SetVSyncDisabled(AVRO_Ticket _ticket)
        {
        ...
        public static void SetFullResolutionMipMap(AVRO_Ticket _ticket)
        {
        ...
        public static void SetAnisotropicTexturesPerTexture(AVRO_Ticket _ticket)
        {
        ...
        public static void SetMipMapStreaming(AVRO_Ticket _ticket)
        {
        ...
        public static void SetShadowmaskMode(AVRO_Ticket _ticket)
        {
        ...
        public static void SetSkinWeightsTwoBones(AVRO_Ticket _ticket)
        {
        ...
        public static void SetBatchRendererGroupKeepAll(AVRO_Ticket _ticket)
        {
            string _path = "ProjectSettings/GraphicsSettings.asset";
            if (!File.Exists(_path)) return;
            string _content = File.ReadAllText(_path);
            string _newContent = Regex.Replace(_content, @"(m_BrgStripping:\s*)(0|1)", "${1}2");
            File.WriteAllText(_path, _newContent);
            AssetDatabase.Refresh();
        }
        #endregion
        ...
        public static void SetDepthTextureDisabled(AVRO_Ticket _ticket)
        {
            ...
            {
                _property.SetValue(AVRO_Utilities.URPSettings, false);
        ...
        public static void SetOpaqueTextureDisabled(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsUsingUnityURP || !AVRO_Utilities.IsRendererSelected) return;
            var _property = AVRO_Utilities.URPSettings.GetType().GetProperty("supportsCameraOpaqueTexture");
            if (_property != null && _property.CanWrite && _property.PropertyType == typeof(bool))
        ...
        public static void SetHDRDisabled(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsUsingUnityURP || !AVRO_Utilities.IsRendererSelected) return;
            var _property = AVRO_Utilities.URPSettings.GetType().GetProperty("supportsHDR");
            if (_property != null && _property.CanWrite && _property.PropertyType == typeof(bool))
        ...
        public static void SetMSAA4x(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsUsingUnityURP || !AVRO_Utilities.IsRendererSelected) return;
            var _property = AVRO_Utilities.URPSettings.GetType().GetProperty("msaaSampleCount");
            if (_property != null && _property.PropertyType == typeof(int) && _property.CanWrite)
            {
                _property.SetValue(AVRO_Utilities.URPSettings, 4);
                EditorUtility.SetDirty((UnityEngine.Object)AVRO_Utilities.URPSettings);
            }
        }
        ...
        public static void SetRenderScaleOne(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsUsingUnityURP || !AVRO_Utilities.IsRendererSelected) return;
            var _property = AVRO_Utilities.URPSettings.GetType().GetProperty("renderScale");
            if (_property != null && _property.PropertyType == typeof(float) && _property.CanWrite)
            {
                _property.SetValue(AVRO_Utilities.URPSettings, 1.0f);
                EditorUtility.SetDirty((UnityEngine.Object)AVRO_Utilities.URPSettings);
            }
        }
        ...
        public static void SetNoAdditionalLights(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsUsingUnityURP || !AVRO_Utilities.IsRendererSelected) return;
            var _maxAdditionalLightsCountProp = AVRO_Utilities.URPSettings.GetType().GetProperty("maxAdditionalLightsCount");
            var _additionalLightsRenderingModeProp = AVRO_Utilities.URPSettings.GetType().GetProperty("additionalLightsRenderingMode");
            if (_maxAdditionalLightsCountProp != null && _additionalLightsRenderingModeProp != null)
            {
                _maxAdditionalLightsCountProp.SetValue(AVRO_Utilities.URPSettings, 0);
                _additionalLightsRenderingModeProp.SetValue(AVRO_Utilities.URPSettings, 0);
                EditorUtility.SetDirty((UnityEngine.Object)AVRO_Utilities.URPSettings);
            }
        }
        ...
        public static void SetDisableMainLight(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsUsingUnityURP || !AVRO_Utilities.IsRendererSelected) return;
            var _type = AVRO_Utilities.URPSettings.GetType();
            var _mainLightRenderingModeProp = _type.GetProperty("mainLightRenderingMode");
            if (_mainLightRenderingModeProp != null && _mainLightRenderingModeProp.CanWrite)
            {
                ...
                _mainLightRenderingModeProp.SetValue(AVRO_Utilities.URPSettings, _disabledValue);
                EditorUtility.SetDirty((UnityEngine.Object)AVRO_Utilities.URPSettings);
            }
        }
        ...
        public static void SetPostProcessingDisabled(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsUsingUnityURP || !AVRO_Utilities.IsRendererSelected)
                return;
            var _urpType = AVRO_Utilities.URPSettings.GetType();
            ...
            if (_postProcessField == null)
                return;
            _postProcessField.SetValue(_rendererData, null);
        }
        ...
        public static void SetRenderingPathForwardPlus(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsUsingUnityURP || !AVRO_Utilities.IsRendererSelected)
                return;
            var _urpType = AVRO_Utilities.URPSettings.GetType();
            ...
            if (_renderingModeField != null)
            {
                ...
                var _forwardPlusValue = Enum.Parse(_enumType, "ForwardPlus");
                _renderingModeField.SetValue(_rendererData, _forwardPlusValue);
            }
            else
            {
                var _renderingModeProperty = _rendererType.GetProperty("renderingMode", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
                ...
                var _forwardPlusValue = Enum.Parse(_enumType, "ForwardPlus");
                _renderingModeProperty.SetValue(_rendererData, _forwardPlusValue);
            }
            EditorUtility.SetDirty((UnityEngine.Object)AVRO_Utilities.URPSettings);
        }
        ...
        public static void SetGPUResidentDrawerEnabled(AVRO_Ticket _ticket)
        {
            ...
            if (_field != null)
            {
                var enumValue = Enum.ToObject(_field.FieldType, 0);
        ...
        public static void SetGPUOcclusionCullingEnabled(AVRO_Ticket _ticket)
        {
            ...
            if (_field != null)
            {
                _field.SetValue(AVRO_Utilities.URPSettings, false);
                EditorUtility.SetDirty((UnityEngine.Object)AVRO_Utilities.URPSettings);
            }
        }
#endif
        ...
        public static void SetOculusTargetDevice(AVRO_Ticket _ticket)
        {
            // Oculus
            if (AVRO_Utilities.IsOculusXRInstalled && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.Oculus)
            {
                ...
                foreach (string _propName in _propertyNames)
                {
                    ...
                    if (_property != null && _property.FieldType == typeof(bool))
                    {
                        _property.SetValue(AVRO_Utilities.OculusSettings, true);
                    }
                }
            ...
            {
                AVRO_Utilities.SetOpenXRDictionaryValue("MetaQuestFeature@targetDevices", true, true);
            }
        }
        ...
        public static void SetMultiviewEnabled(AVRO_Ticket _ticket)
        {
            ...
            object _multiviewValue = Enum.Parse(_enumType, "Multiview");
        ...
        public static void SetOptimizeBufferDiscards(AVRO_Ticket _ticket)
        {
            ...
            if (AVRO_Utilities.IsOculusXRInstalled && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.Oculus)
            {
                ...
                _optimizeBufferDiscards.SetValue(AVRO_Utilities.OculusSettings, true);
                AVRO_Utilities.SetDirtyReflectionOf(AVRO_Utilities.OculusSettings);
            }
            // OpenXR
            else if (AVRO_Utilities.IsOpenXRInstalled && AVRO_Utilities.OpenXRSettingsDictionary != null && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.OpenXR)
            {
                AVRO_Utilities.SetOpenXRDictionaryValue("MetaQuestFeature@optimizeBufferDiscards", true, true);
            }
        }
        ...
        public static void SetSymmetricProjection(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsVulkanUsed) return;
            // Oculus
            if (AVRO_Utilities.IsOculusXRInstalled && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.Oculus)
            {
                ...
                _symmetricProjection.SetValue(AVRO_Utilities.OculusSettings, true);
                AVRO_Utilities.SetDirtyReflectionOf(AVRO_Utilities.OculusSettings);
            }
            // OpenXR
            else if (AVRO_Utilities.IsOpenXRInstalled && AVRO_Utilities.OpenXRSettingsDictionary != null && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.OpenXR)
            {
                AVRO_Utilities.SetOpenXRDictionaryValue("MetaQuestFeature@symmetricProjection", true, true);
            }
        }
        ...
        public static void SetSubsampleLayout(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsVulkanUsed) return;
            // Oculus
            if (AVRO_Utilities.IsOculusXRInstalled && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.Oculus)
            {
                ...
                _subsampledLayout.SetValue(AVRO_Utilities.OculusSettings, true);
                AVRO_Utilities.SetDirtyReflectionOf(AVRO_Utilities.OculusSettings);
            }
            // OpenXR
            else if (AVRO_Utilities.IsOpenXRInstalled && AVRO_Utilities.OpenXRSettingsDictionary != null && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.OpenXR)
        ...
        public static void SetVulkanDepthSubmission(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsOculusXRInstalled || !AVRO_Utilities.IsVulkanUsed) return;
            FieldInfo _depthSubmission = AVRO_Utilities.OculusSettings.GetType().GetField("DepthSubmission");
            if (_depthSubmission == null) return;
            _depthSubmission.SetValue(AVRO_Utilities.OculusSettings, true);
            AVRO_Utilities.SetDirtyReflectionOf(AVRO_Utilities.OculusSettings);
        }
        ...
        public static void SetVulkanLateLatching(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsVulkanUsed) return;
            // Oculus
            if (AVRO_Utilities.IsOculusXRInstalled && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.Oculus)
            {
                ...
                _lateLatching.SetValue(AVRO_Utilities.OculusSettings, true);
                AVRO_Utilities.SetDirtyReflectionOf(AVRO_Utilities.OculusSettings);
            }
            // OpenXR
            else if (AVRO_Utilities.IsOpenXRInstalled && AVRO_Utilities.OpenXRSettingsDictionary != null && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.OpenXR)
            {
                AVRO_Utilities.SetOpenXRDictionaryValue("MetaQuestFeature@lateLatchingMode", true, true);
            }
        }
        ...
        public static void SetOpenGLESLowOverhead(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsOculusXRInstalled || AVRO_Utilities.IsVulkanUsed) return;
            FieldInfo _lowOverheadModeProperty = AVRO_Utilities.OculusSettings.GetType().GetField("LowOverheadMode");
            if (_lowOverheadModeProperty == null) return;
            _lowOverheadModeProperty.SetValue(AVRO_Utilities.OculusSettings, true);
            AVRO_Utilities.SetDirtyReflectionOf(AVRO_Utilities.OculusSettings);
        }
        ...
        public static void SetFixedFoveatedRendering(AVRO_Ticket _ticket)
        {
            // Oculus
            if (AVRO_Utilities.IsOculusXRInstalled && AVRO_Utilities.XRLoaderName == AVRO_Utilities.XRLoaderNames.Oculus)
            {
                ...
                object _multiviewValue = Enum.Parse(_enumType, "FixedFoveatedRendering");
            ...
            {
                AVRO_Utilities.SetOpenXRDictionaryValue("MetaXRFoveationFeature", true, true);
            }
        }
        ...
        {
            if (!AVRO_Utilities.IsOpenXRInstalled || AVRO_Utilities.OpenXRSettingsDictionary == null)
                return AVRO_Settings.TicketStates.Omitted;
            int _result = AVRO_Utilities.SetOpenXRDictionaryValue("FoveatedRendering");
            return _result == 1 ? AVRO_Settings.TicketStates.Done : _result == -1 ? AVRO_Settings.TicketStates.Omitted : AVRO_Settings.TicketStates.Todo;
        }
        public static void SetOpenXRFoveatedRendering(AVRO_Ticket _ticket)
        {
            if (!AVRO_Utilities.IsOpenXRInstalled || AVRO_Utilities.OpenXRSettingsDictionary == null) return;
            AVRO_Utilities.SetOpenXRDictionaryValue("FoveatedRendering", true, true);
        }
        #endregion
    }
}